<?php defined('BASEPATH') OR exit('no direct script access allowed');
	...
	class  Crud_modal extends CI_Controller	{
		...
		{
			$user_data['link_crud_modal'] = 'active';
			$user_data['agama'] = $this->mdl->get_agama();
			$this->load->view('header',$user_data);
			$this->load->view('crudmodal/data',$user_data);
		}
		...
		public function ajax_list()
		{
			...
			foreach($list as $post)
			{
				...
				//add html for action
				$row[] = '<a class="btn btn-xs btn-primary" href="javascript:void()" onclick="edit('."'".$post->user_id."'".')" title="Edit"><i class="fa fa-edit"></i> Edit</a>
